...
const EditMode = ({ tweet, close }) => {
  ...
  return (
    <>
      ...
      <button
        onClick={handleSave}
        className="mx-5 p-2 border text-green-500 rounded-lg shadow hover:bg-zinc-700 transition"
      >
        <BiSolidSave />
      </button>
      <button
        className="mx-5 p-2 border text-red-500 rounded-lg shadow hover:bg-zinc-700 transition"
        onClick={close}
      >
        <ImCancelCircle />
      </button>
